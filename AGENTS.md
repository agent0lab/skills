...
- For payment-required (x402) or A2A messaging/task flows, load the relevant agent0 reference files (ts-x402, py-x402, ts-a2a, py-a2a, and related x402/a2a references).
